...
for symbol in symbolList:
  # =====读入数据
  # symbol = 'SOL-USDT_5m'
  df = pd.read_hdf('/Users/caoliang/PycharmProjects/xbx_part_3/data/%s.h5' % symbol, key='df')
  ...
  # =====将数据存入hdf文件中
  df.to_hdf('/Users/caoliang/PycharmProjects/xbx_part_3/data/%s_signals.h5' % symbol, key='df', mode='w')
