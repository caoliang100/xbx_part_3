...
for symbol in symbolList:
    # ===导入数据
    df = pd.read_hdf('/Users/caoliang/PycharmProjects/xbx_part_3/data/%s_signals.h5' % symbol, key='df')
    ...
    df.to_hdf('/Users/caoliang/PycharmProjects/xbx_part_3/data/%s_pos.h5' % symbol, key='df', mode='w')
